...
import cc.meiwen.R;
import cc.meiwen.view.pickerview.adapter.ArrayWheelAdapter;
...
public class WheelOptions<T> {
	...
	public void setPicker(ArrayList<T> optionsItems) throws Exception{
		setPicker(optionsItems, null, null, false);
	}

	public void setPicker(ArrayList<T> options1Items,
						  ArrayList<ArrayList<T>> options2Items, boolean linkage) throws Exception{
	...
	public void setPicker(ArrayList<T> options1Items,
			...
			boolean linkage) throws Exception{
