package cc.meiwen.view.pickerview.lib;
...
import cc.meiwen.view.pickerview.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        try {
            ...
            Log.d("", "出错了！adapter.getItemsCount() == 0，联动数据不匹配");
        }
        if (!isLoop) {//不循环的情况
    ...
    private String getContentText(Object item) {
        ...
        try {
            ...
            boolean isZh = AppUtils.isZh();
            if (isZh && contentText.length() > 6) {
                contentText = contentText.substring(0, 5) + "...";
            } else if (!isZh && contentText.length() > 10) {
                contentText = contentText.substring(0, 9) + "...";
            }
